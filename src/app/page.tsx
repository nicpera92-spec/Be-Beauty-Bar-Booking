...
export default function HomePage() {
  ...
  return (
    <div className="relative flex flex-1 flex-col justify-center overflow-hidden sm:min-h-[70vh] sm:flex-none sm:block">
      <div
      ...
      <div className="relative max-w-3xl mx-auto w-full px-5 sm:px-8 py-10 sm:py-28 md:py-40 text-center">
